<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<h2 class="myH text-center">Wish List</h2>
		<h5 class="text-center">위시 리스트</h5>
		<p class="text-center mt20">가보고 싶은 관광지, 음식점, 숙박시설 정보입니다.</p>
		...
		<div class="row text-center justify-content-center mt36">
			...
			<div class="col-7">
									...
									<c:forEach items="${wishList }" var="w">
										<tr>
											...
											<td id="map">
												...
												<button type="submit" class="btn btn-danger mt20" onclick="deleteBtnFun()">삭제</button>
											</td>
										</tr>
									</c:forEach>
								</c:if>
				...
				<div>
					<a href="javascript:history.go(-1);" class="btn btn-primary mt20">목록</a>
